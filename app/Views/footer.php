            ...
            <div class="row">
                <div class="col-md-3" style="cursor: pointer">
                    <div class="single_what_we_do tab_a">
                        ...
                        <div class="what_we_do_content" style="margin-top:-50px;"><img style="width: 100px;height: 100px;" src="http://localhost/AdminTravelCode/public/img/S-01.png"></div>
                ...
                <div class="col-md-3" style="cursor: pointer">
                    <div class="single_what_we_do tab_b">
                        ...
                        <div class="what_we_do_content" style="margin-top:-50px;"><img style="width: 100px;height: 100px;" src="http://localhost/AdminTravelCode/public/img/S-03.png"></div>
                ...
                <div class="col-md-3" style="cursor: pointer">
                    <div class="single_what_we_do tab_c">
                        ...
                        <div class="what_we_do_content" style="margin-top:-50px;"><img style="width: 120px;height: 100px;" src="http://localhost/AdminTravelCode/public/img/S-04.png"></div>
                ...
                <div class="col-md-3" style="cursor: pointer">
                    <div class="single_what_we_do tab_d">
                        ...
                        <div class="what_we_do_content" style="margin-top:-50px;"><img style="width: 100px;height: 100px;" src="http://localhost/AdminTravelCode/public/img/S-05.png"></div>
                            ...
                            <ul>
                                <li class="footer_contact_item">
                                    <div class="footer_contact_icon">
                                        <img src="http://localhost/AdminTravelCode/public/img/placeholder.svg" alt="https://www.flaticon.com/authors/lucy-g">
                                    </div>
                                    Cl. 6 #8-54, Neiva, Huila
                                </li>
                                <li class="footer_contact_item">
                                    <div class="footer_contact_icon">
                                        <img src="http://localhost/AdminTravelCode/public/img/phone-call.svg" alt="https://www.flaticon.com/authors/lucy-g">
                                    </div>
                                    +57 3005542958
                                </li>
                                <li class="footer_contact_item">
                                    <div class="footer_contact_icon">
                                        <img src="http://localhost/AdminTravelCode/public/img/envelope.svg" alt="https://www.flaticon.com/authors/lucy-g">
